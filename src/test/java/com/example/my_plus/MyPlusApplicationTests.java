...
import com.example.my_plus.entity.Parent;
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.example.my_plus");
...
//        });
        ...
        strategy.setSuperEntityClass(Parent.class.getName());
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
//        strategy.setSuperControllerClass(Parent.class.getName());
        // 写于父类中的公共字段
